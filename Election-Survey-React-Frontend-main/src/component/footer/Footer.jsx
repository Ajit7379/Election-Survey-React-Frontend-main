        ...
        <footer className={styles.footer}>
            <div className={styles.container}>
                ...
                <div className={styles.section}>
                    ...
                    <p>👨‍💻 <strong>Developed by: Ajit Pandey</strong></p>
                    ...
                    <div className={styles.socialIcons}>
                        ...
                        <a 
                            href="https://www.linkedin.com/in/ajitpandey77040/" 
                            target="_blank" 
                            rel="noopener noreferrer"
                        >
                        ...
                        <a 
                            href="https://x.com/ajit_pandey7379" 
                            target="_blank" 
                            rel="noopener noreferrer"
                        >
            ...
            <div className={styles.copyright}>
                ...
                <p>
                    📧 Contact: 
                    <a href="mailto:ajitpandey77040@gmail.com">
                        <FontAwesomeIcon icon={faEnvelope} className={styles.icon} /> ajitpandey77040@gmail.com
                    </a>
                </p>
            </div>
        </footer>
